...
(function($) {
	...
	var MetaBoxes = {
		...
		init: function() {
			// Handle uploads
			$( '.kickoff-meta-boxes' ).on( 'click', '.upload-select', this.selectUpload );
			$( '.kickoff-meta-boxes' ).on( 'click', '.upload-remove', this.removeUpload );
			// Handle repeaters
			$( '.kickoff-meta-boxes .meta-sortable' ).sortable({ placeholder: 'repeater-gap' });
			$( '.kickoff-meta-boxes' ).on( 'click', '.repeater-add', this.addRepeater );
			$( '.kickoff-meta-boxes' ).on( 'click', '.repeater-remove', this.removeRepeater );
			// Load color picker
			$( '.kickoff-meta-boxes .color-picker' ).wpColorPicker();
		},
